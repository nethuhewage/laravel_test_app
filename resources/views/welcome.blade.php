        ...
        <div class="mt-6 flex flex-wrap justify-center gap-4">
            @auth
                <a href="{{ url('/dashboard') }}"
                   class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-lg">
                    🚀 Go to Dashboard
                </a>
            @else
                <a href="{{ route('login') }}"
                   class="px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg shadow-lg">
                    🔑 Login
                </a>
                <a href="{{ route('register') }}"
                   class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg shadow-lg">
                    ✍️ Register
                </a>
            @endauth
        </div>
    ...
    <div class="px-6 py-10 grid md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        <div>
            ...
            <ul class="space-y-2 text-sm">
                <li><a href="/" class="text-gray-600 dark:text-gray-400 hover:text-red-600">Home</a></li>
                <li><a href="#about" class="text-gray-600 dark:text-gray-400 hover:text-red-600">About</a></li>
                <li><a href="#gallery" class="text-gray-600 dark:text-gray-400 hover:text-red-600">Gallery</a></li>
                <li><a href="#contact" class="text-gray-600 dark:text-gray-400 hover:text-red-600">Contact</a></li>
            </ul>
        </div>
        ...
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400 text-sm">📧 info@synotec.com</p>
            <p class="text-gray-600 dark:text-gray-400 text-sm">📞 +94 77 295 56 59</p>
        </div>
    </div>
